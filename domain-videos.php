...
$app->get( "/:desdomain/videos", function( $desdomain )
{
	...
	elseif( User::checkDesdomain($desdomain) )
	{
		...
		$results = $video->getTemplatePage((int)$user->getiduser(),$currentPage,Rule::ITENS_PER_PAGE);
		...
		{ 
			...
			array_push(
				...
				[
					...
					'href'=>'/'.$user->getdesdomain().'/videos?'.http_build_query(
