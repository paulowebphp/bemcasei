...
$app->get( "/checkout/:hash", function( $hash )
{
	...
	if (
		...
		isset($couponIsApplied['vlpercentage'])
		&&
		(int)$couponIsApplied['vlpercentage'] == 0 
	)
	{
		# code...
		$voucher = 1;
			...
			if ( $couponExists = Coupon::checkCouponExists($coupon) ) 
			{
				...
				if ( $dtexpire > $dtnow ) 
				{
					...
					if ( 
						...
						!$couponIsApplied = Coupon::checkCouponIsApplied(
