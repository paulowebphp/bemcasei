...
<body>
  ...
  <section id="email-canvas">
      ...
      <div class="email-row">
         ...
         <span><strong><?php echo htmlspecialchars( $order["desname"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> realizou a compra de um presente na sua Loja Virtual. Só precisamos aguardar o pagamento do Boleto para finalizar.</span>
      ...
      <div class="email-row">
         ...
         <span>Depois do pagamento, o prazo de compensação é de até 4 dias úteis. Você receberá uma confirmação por e-mail, mas se preferir, pode acompanhar o status da compra no painel de controle do Bem Casei.</span>
      ...
      <div class="email-row">
         ...
         <span>Basta fazer Login no Bem Casei e ir no menu "Loja" e depois em "Painel Financeiro".</span>
      ...
      <div class="email-row">
        ...
        <span>
          Faça login no <strong>Bem Casei</strong> para gerenciar sua Loja Virtual
        </span>
