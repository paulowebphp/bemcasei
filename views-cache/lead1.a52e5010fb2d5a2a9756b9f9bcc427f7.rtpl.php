...
<body>
  ...
  <section id="email-canvas">
      ...
      <div class="email-row">
         ...
         <span>A senha para o e-mail: <strong><?php echo htmlspecialchars( $lead["desemail"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> é: <strong><?php echo htmlspecialchars( $lead["desoriginalpassword"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong>.</span>
