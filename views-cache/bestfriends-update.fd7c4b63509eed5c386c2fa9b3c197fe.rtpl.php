    ...
    <div class="container-fluid">            
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-12 dash-panel">
               ...
               <form action='/dashboard/padrinhos-madrinhas/<?php echo setHash($bestfriend["idbestfriend"]); ?>' method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 dash-column">
                            ...
                            <div class="dash-input-row">
                                ...
                                <input type="hidden" class="form-control" id="idbestfriend" name="idbestfriend" value='<?php echo setHash($bestfriend["idbestfriend"]); ?>'>
