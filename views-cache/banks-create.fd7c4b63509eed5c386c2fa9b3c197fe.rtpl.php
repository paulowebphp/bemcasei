    ...
    <div class="container-fluid">            
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-12 dash-panel">
               ...
               <form id="dataBank" method="post" action="/dashboard/conta-bancaria/adicionar">
                        ...
                        <div class="col-md-9 dash-column">
                            ...
                            <div class="dash-input-row">
                                ...
                                <select form="dataBank" id="desbanknumber" name="desbanknumber">
                                    ...
                                    <?php $counter1=-1;  if( isset($bankvalues) && ( is_array($bankvalues) || $bankvalues instanceof Traversable ) && sizeof($bankvalues) ) foreach( $bankvalues as $key1 => $value1 ){ $counter1++; ?>
                                        <option value="<?php echo htmlspecialchars( $bankvalues["$counter1"]["value"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $bankvalues["$counter1"]["name"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                                    <?php } ?>
                            ...
                            <div class="dash-input-row input-date">
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <select form="dataBank" id="desaccounttype" name="desaccounttype" class="custom-select">
                                    ...
                                    <option selected value="CHECKING">Conta Corrente</option>
                            ...
                            <div class="row dash-input-row row-2-columns account-row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="desname">Nome do Titular</label>
                            ...
                            <div class="row dash-input-row row-2-columns account-row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="desdocument">CPF do Titular</label>

                                    <div id="desdocument">

                                        <input type="text" class="form-control" id="desdocument" name="desdocument">
                            ...
                            <div class="row dash-input-row row-2-columns account-row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div id="desagencynumber">
                                        ...
                                        <input type="text" class="form-control" id="desagencynumber" name="desagencynumber">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div id="desagencycheck">
                                        ...
                                        <input type="text" class="form-control" id="desagencycheck" name="desagencycheck">
                            ...
                            <div class="row dash-input-row row-2-columns account-row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div id="desaccountnumber">
                                        ...
                                        <input type="text" class="form-control" id="desaccountnumber" name="desaccountnumber">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div id="desaccountcheck">
                                        ...
                                        <input type="text" class="form-control" id="desaccountcheck" name="desaccountcheck">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="dash-input-row input-footer">
                                ...
                                <a href="/dashboard/sua-carteira" class="btn btn-danger">Voltar</a>
