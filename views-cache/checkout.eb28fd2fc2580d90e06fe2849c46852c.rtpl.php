					...
					<div class="row centralizer">
						...
						<div class="col-md-8 col-12">
							...
							<div class="payment-block card-info">
								...
								<form id="checkout-form1" action="/checkout/<?php echo htmlspecialchars( $hash, ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="checkout" method="post" name="checkout">
    			...
    			<div id="payment-inputs2" style="display:none;">
    				...
    				<div class="row">
    					<div class="col-12 payment-block">
    						<form id="checkout-form2" action="/checkout/<?php echo htmlspecialchars( $hash, ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="width100 flex" method="post" name="checkout">
