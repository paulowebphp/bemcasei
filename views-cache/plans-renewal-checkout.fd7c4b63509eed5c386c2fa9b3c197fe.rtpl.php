								...
								<div class="col-md-6">
									...
									<div class="payment-block">
										...
										<form id="checkout-form3" action="/dashboard/renovar/checkout" class="checkout" method="post" name="checkout">
											...
											<div class="row2">
												<input type="text" placeholder="Nome do Titular do Cartão" name="desname" class="input-text" value="<?php echo htmlspecialchars( $planRenewalValues["desname"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
											</div>
											...
											<div class="row2 row">
												...
												<div class="col-md-5">
													<input type="text" placeholder="DDD" name="nrddd" class="input-text" value="<?php echo htmlspecialchars( $planRenewalValues["nrddd"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
												</div>



												<div class="col-md-7">
													<input type="text" placeholder="Telefone" name="nrphone" class="input-text" value="<?php echo htmlspecialchars( $planRenewalValues["nrphone"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
												</div>
											...
											<div class="birth-field-text row2 row">
												...
												<div class="col-8">
													<input type="date" placeholder="Nascimento" name="dtbirth" class="input-text" value="<?php echo htmlspecialchars( $planRenewalValues["dtbirth"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
										...
										<div class="payment-block">
											...
											<div class="row2">
												<input type="text" placeholder="CEP do Titular do Cartão" name="deszipcode" class="input-text" value="<?php echo htmlspecialchars( $planRenewalValues["deszipcode"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
												
											</div>

											<div class="row2">
												<input type="text" placeholder="Logradouro, rua, avenida" name="desaddress" class="input-text" value="<?php echo htmlspecialchars( $planRenewalValues["desaddress"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
											</div>

											<div class="row2">
												<input type="text" placeholder="Número" name="desnumber" class="input-text" value="<?php echo htmlspecialchars( $planRenewalValues["desnumber"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
											</div>

											<div class="row2">
												<input type="text" placeholder="Complemento (opcional)" name="descomplement" class="input-text" value="<?php echo htmlspecialchars( $planRenewalValues["descomplement"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
							                </div>

							                <div class="row2">
												<input type="text" placeholder="Bairro" name="desdistrict" class="input-text" value="<?php echo htmlspecialchars( $planRenewalValues["desdistrict"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
											</div>
											...
											<div class="state-city">
												...
												<select id="state3" form="checkout-form3" name="desstate">
							                    	<?php $counter1=-1;  if( isset($state) && ( is_array($state) || $state instanceof Traversable ) && sizeof($state) ) foreach( $state as $key1 => $value1 ){ $counter1++; ?> 
														<option value="<?php echo htmlspecialchars( $value1["idstate"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" <?php if( $value1["idstate"] == $planRenewalValues["desstate"] ){ ?>selected="selected"<?php } ?>><?php echo htmlspecialchars( $value1["desstate"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
													<?php } ?> 
							                	</select>
											...
											<div class="state-city">
												...
												<select id="city3" form="checkout-form3" name="descity">
							                    	<?php $counter1=-1;  if( isset($city2) && ( is_array($city2) || $city2 instanceof Traversable ) && sizeof($city2) ) foreach( $city2 as $key1 => $value1 ){ $counter1++; ?>
														<option value="<?php echo htmlspecialchars( $value1["idcity"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" <?php if( $value1["idcity"] == $planRenewalValues["descity"] ){ ?>selected="selected"<?php } ?>><?php echo htmlspecialchars( $value1["descity"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
													<?php } ?>
							                </select>
									...
									<div class="col-md-6">
										...
										<div class="row">
											<div class="col-12">
												<div class="payment-block">
													<div class="row2">
														<input type="text" placeholder="CPF do Titular do Cartão" name="desdocument" class="input-text" value="<?php echo htmlspecialchars( $planRenewalValues["desdocument"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
													</div>
												</div>
											</div>
										</div>
