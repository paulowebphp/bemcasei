...
<body>
  ...
  <section id="email-canvas">
      ...
      <div class="email-row detail">
        ...
        <span class="email-label1">Adultos: &nbsp;&nbsp;</span><span class="email-label2"><?php if( $rsvp["inadultsconfirmed"] > 0 ){ ?><?php echo htmlspecialchars( $rsvp["inadultsconfirmed"], ENT_COMPAT, 'UTF-8', FALSE ); ?> em <?php echo getMaxAdults($rsvp["inmaxadults"],$rsvpconfig["inadultsconfig"],$rsvpconfig["inmaxadultsconfig"]); ?> permitidos<?php }else{ ?>0<?php } ?></span>
      ...
      <div class="email-row detail">
        ...
        <span class="email-label1">Crianças: &nbsp;&nbsp;</span><span class="email-label2"><?php if( $rsvp["inchildrenconfirmed"] > 0 ){ ?><?php echo htmlspecialchars( $rsvp["inchildrenconfirmed"], ENT_COMPAT, 'UTF-8', FALSE ); ?> em <?php echo getMaxChildren($rsvp["inmaxchildren"],$rsvpconfig["inchildrenconfig"],$rsvpconfig["inmaxchildrenconfig"]); ?> permitidos<?php }else{ ?>0<?php } ?></span>
      ...
      <div class="email-row2 detail">
        ...
        <span class="email-label1">Nomes dos Acompanhantes: &nbsp;&nbsp;</span><span class="email-label2"><?php echo htmlspecialchars( $rsvp["desguestaccompanies"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
