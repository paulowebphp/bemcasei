<?php if(!class_exists('Rain\Tpl')){exit;}?><footer id="template5" class="text-center">
        ...
        <div id="footer-first-row" class="row">
            ...
            <div class="col-md-4 footer-column">
                ...
                <div class="caption">
                    ...
                    <a href='/template/<?php echo getTemplate(); ?>/cerimonia' class="list-group-item list-group-item-action">Cerimônia</a>

                    <a href='/template/<?php echo getTemplate(); ?>/festa' class="list-group-item list-group-item-action">Festa</a>
                    ...
                    <a href='/modelos-templates' class="list-group-item list-group-item-action"><i class="fa fa-sign-out"></i> Voltar para o Amar Casar</a>
            ...
            <div class="col-md-4 footer-column socials">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 caption">
                            ...
                            <ul class="list-socials list-unstyled list-group list-group-horizontal">
                                ...
                                <li>
                                    <div class="social-icon-border"><i class="fa fa-facebook"></i></div>
                                </li>


                                <li>
                                    <div class="social-icon-border"><i class="fa fa-instagram"></i></div>
                                </li>

                                <li>
                                    <div class="social-icon-border"><i class="fa fa-youtube"></i></div>
                                </li>


                                <li>
                                    <div class="social-icon-border"><i class="fa fa-twitter"></i></div>
                                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 caption">
                            ...
                            <h2>Redes Sociais de <?php echo getTemplateNames(1); ?></h2>

                            <!-- <div class="col-xs-4 text-center"> <a href="#"><img src="&lt;?php echo DIR_RESOURCES; ?&gt;/images/twitter64.png" alt="Placeholder image" width="86" height="86" class="img-responsive"></div></div> -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 caption">
                            ...
                            <h2>Redes Sociais de <?php echo getTemplateNames(2); ?></h2>
    ...
    <div class="row centralizer">
        ...
        <div class="col-md-12 bottom-footer">
            ...
            <div class="caption">
                ...
                <p>Amar Casar © <?php echo getYear(); ?> - CNPJ 34.700.513/0001-27<br><a href="/termos-uso">Termos de Uso</a> | <a href="/termos-lista">Termos da Lista de Presentes Virtuais</a> | <a href="/politica-privacidade">Política de Privacidade</a> | <a href="/contato">Dúvidas e Suporte</a></p>
