    ...
    <div class="container-fluid">            
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-12 dash-panel">
               ...
               <form method="post" action='/dashboard/videos/<?php echo setHash($video["idvideo"]); ?>'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 dash-column">
                            ...
                            <div class="dash-input-row">
                                 ...
                                 <input type="hidden" class="form-control" id="idvideo" name="idvideo" placeholder="Digite o nome aqui" value='<?php echo setHash($video["idvideo"]); ?>'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="dash-input-row input-footer">
                                ...
                                <a href="/dashboard/videos" class="btn btn-danger">Voltar</a>
