<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="list-group">
    ...
    <div class="accordion" id="accordion">
        ...
        <div class="card">
            ...
            <div id="collapseOne" class="collapse<?php if( in_array(getUri($_SERVER['REQUEST_URI']) , ['painel-financeiro','presentes-virtuais','lista-pronta','sua-carteira','conta-bancaria','transferencias']) ){ ?> show<?php } ?>" aria-labelledby="headingOne" data-parent="#accordion">
        ...
        <div class="card">
            ...
            <div id="collapseThree" class="collapse<?php if( in_array(getUri($_SERVER['REQUEST_URI']), ['meu-casamento','meu-amor','festa-de-casamento','padrinhos-madrinhas']) ){ ?> show<?php } ?>" aria-labelledby="headingThree" data-parent="#accordion">
