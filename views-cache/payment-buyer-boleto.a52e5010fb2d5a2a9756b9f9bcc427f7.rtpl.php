...
<body>
  ...
  <section id="email-canvas">
      ...
      <div class="email-row">
        ...
        <span>Olá, <strong><?php echo htmlspecialchars( $order["desname"], ENT_COMPAT, 'UTF-8', FALSE ); ?>!</strong></span>
      ...
      <div class="email-row">
         ...
         <span>Quase lá! Efetue o pagamento do Boleto para finalizar a compra do presente para <?php echo htmlspecialchars( $user["desnick"], ENT_COMPAT, 'UTF-8', FALSE ); ?> & <?php echo htmlspecialchars( $consort["desconsort"], ENT_COMPAT, 'UTF-8', FALSE ); ?>.</span>
      ...
      <div class="email-row">
         ...
         <span>O prazo de compensação após o pagamento é de até 4 dias úteis. Você e o casal receberão uma confirmação por e-mail.</span>
      ...
      <div class="email-row">
        ...
        <span>
          Busque o nome do casal no <strong>Bem Casei</strong> para encantar-se com histórias, fotos, vídeos e muito mais!
        </span>
