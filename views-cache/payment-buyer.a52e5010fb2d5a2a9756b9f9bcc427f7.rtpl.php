...
<body>
  ...
  <section id="email-canvas">
      ...
      <div class="email-row">
         ...
         <span>Você efetuou uma compra na Loja Virtual de <strong><?php echo htmlspecialchars( $user["desnick"], ENT_COMPAT, 'UTF-8', FALSE ); ?> e <?php echo htmlspecialchars( $consort["desconsort"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong>. Confira os dados abaixo:</span>
      ...
      <div class="email-row">
        ...
        <span>
          Busque o nome do casal no <strong>Amar Casar</strong> para encantar-se com histórias, fotos, vídeos e muito mais!
        </span>
      ...
      <div class="email-row email-button">
        ...
        <a target="_blank" href="https://amarcasar.com/buscar">
