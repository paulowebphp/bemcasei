                                ...
                                <div class="list-group">
                                    ...
                                    <div class="accordion" id="accordion6">
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseTen" class="collapse<?php if( in_array(getUri($_SERVER['REQUEST_URI']) , ['painel-financeiro','presentes-virtuais','lista-pronta','sua-carteira','cadastrar','conta-bancaria','transferencias']) ){ ?> show<?php } ?>" aria-labelledby="headingTen" data-parent="#accordion6">
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseTwelve" class="collapse<?php if( in_array(getUri($_SERVER['REQUEST_URI']), ['meu-casamento','meu-amor','festa-de-casamento']) ){ ?> show<?php } ?>" aria-labelledby="headingTwelve" data-parent="#accordion6">
