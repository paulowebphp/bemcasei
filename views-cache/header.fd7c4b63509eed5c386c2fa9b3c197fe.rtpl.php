                                ...
                                <div class="list-group">
                                    ...
                                    <div class="accordion" id="accordion4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseSix" class="collapse<?php if( in_array(getUri($_SERVER['REQUEST_URI']) , ['painel-financeiro','presentes-virtuais','lista-pronta']) ){ ?> show<?php } ?>" aria-labelledby="headingSix" data-parent="#accordion4">
                                                <div class="card-body card-body-text">
