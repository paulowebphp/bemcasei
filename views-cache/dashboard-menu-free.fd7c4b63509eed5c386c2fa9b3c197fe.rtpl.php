<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="list-group">
    ...
    <div class="accordion" id="accordion">
        ...
        <div class="card">
            ...
            <div id="collapseTwo" class="collapse<?php if( in_array(getUri($_SERVER['REQUEST_URI']) , ['meu-casamento','meu-amor','festa-de-casamento','padrinhos-madrinhas']) ){ ?> show<?php } ?>" aria-labelledby="headingTwo" data-parent="#accordion">
