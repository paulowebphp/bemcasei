        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="section-title">
                    ...
                    <a href="/<?php echo htmlspecialchars( $user["desdomain"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/fornecedores">
                    ...
                    <div class="card2">
                        ...
                        <div class="title row">
                            ...
                            <div class="col-12">
                                ...
                                <h5><?php echo htmlspecialchars( $value1["desstakeholder"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h5>
                        ...
                        <div class="body-row centralizer row">
                            ...
                            <div class="col-md-4 col-12 inside-row">
                                ...
                                <h5><?php echo htmlspecialchars( $value1["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h5>
                        ...
                        <div class="body-footer centralizer row">
                            ...
                            <div class="col-md-6 col-12 inside-row">
                                ...
                                <h5><?php echo htmlspecialchars( $value1["deslocation"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h5>
                            ...
                            <div class="col-md-6 col-12 inside-row">
                                ...
                                <h5>
                                    <?php echo htmlspecialchars( $value1["desemail"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                                </h5>
                                <hr>
