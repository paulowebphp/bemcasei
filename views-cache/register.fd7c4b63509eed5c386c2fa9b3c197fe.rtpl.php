...
<button id="ModalDashRegisterButton">Enviar</button>                                
                            </div>
                ...
                <!-- Modal -->
                <div class="modal fade" id="ModalDashRegister" tabindex="-1" role="dialog" aria-labelledby="ModalDashRegister" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        <h5 class="modal-title" id="ModalDashRegisterTitle">Confira Seus Dados!</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        </div>
                        <div id="ModalBody" class="modal-body">teste</div>
