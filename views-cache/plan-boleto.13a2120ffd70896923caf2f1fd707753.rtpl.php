  ...
  <section id="email-canvas">
    ...
    <?php if( $plan["inmigration"] == 0 ){ ?>
      ...
      <div class="email-row">
         ...
         <span>O prazo de compensação é de até 4 dias úteis. Você receberá uma confirmação por e-mail, mas se preferir, pode visualizar o status no painel de controle do Amar Casar.</span>
      ...
      <div class="email-row">
        ...
        <span>
          Faça login no <strong>Amar Casar</strong> para visualizar o status da sua compra
        </span>
