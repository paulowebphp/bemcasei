    ...
    <div class="container-fluid">            
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-12 dash-panel">
               ...
               <form id="dash-form" method="post" action='/dashboard/eventos/<?php echo setHash($event["idevent"]); ?>' enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="dash-input-row input-date">
                            ...
                            <div class="dash-input-row">
                                 ...
                                 <input type="hidden" class="form-control" id="idevent" name="idevent" value='<?php echo setHash($event["idevent"]); ?>'>
