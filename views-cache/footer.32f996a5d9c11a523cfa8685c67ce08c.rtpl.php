<?php if(!class_exists('Rain\Tpl')){exit;}?><footer class="text-center">
    ...
    <!-- <script src="/res/js/card.js"></script> -->
    ...
    <script type="text/javascript" src="/res/js/register-slideshow.js"></script>
    
    <!-- Slider -->
    <script type="text/javascript" type="text/javascript" src="/res/js/bxslider.min.js"></script>
    <script type="text/javascript" type="text/javascript" src="/res/js/script.slider.js"></script>
