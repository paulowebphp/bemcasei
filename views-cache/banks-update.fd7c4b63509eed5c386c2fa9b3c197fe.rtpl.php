    ...
    <div class="container-fluid">            
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-12 dash-panel">
               ...
               <form id="dataBank" method="post" action='/dashboard/conta-bancaria/<?php echo setHash($bank["idbank"]); ?>'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 dash-column">
                            ...
                            <div class="row dash-input-row row-2-columns account-row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="desname">
                                        ...
                                        <input type="text" class="form-control" id="desname" name="desname" value="<?php echo htmlspecialchars( $bank["desname"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                            ...
                            <div class="row dash-input-row row-2-columns account-row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="desdocument">
                                        ...
                                        <input type="text" disabled class="form-control" id="desdocument" name="desdocument" value="<?php echo htmlspecialchars( $bank["desdocument"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                            ...
                            <div class="row dash-input-row row-2-columns account-row">
                                <input type="hidden" class="form-control" id="idbank" name="idbank" value='{function="setHash($bank.idbank)}'>
                            </div>
