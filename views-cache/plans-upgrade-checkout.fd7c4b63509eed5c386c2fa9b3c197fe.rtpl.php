								...
								<div class="col-md-6">
									...
									<div class="payment-block">
										...
										<form id="checkout-form3" action="/dashboard/upgrade/checkout" class="checkout" method="post" name="checkout">
											...
											<div class="row2">
												<input type="text" placeholder="Número do CPF" name="desholderdocument" class="input-text" value="<?php echo htmlspecialchars( $planUpgradeValues["desholderdocument"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
											</div>
											...
											<div class="row2 row">
												...
												<div class="col-md-5">
													<input type="text" placeholder="DDD" name="nrholderddd" class="input-text" value="<?php echo htmlspecialchars( $planUpgradeValues["nrholderddd"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
												</div>



												<div class="col-md-7">
													<input type="text" placeholder="Telefone" name="nrholderphone" class="input-text" value="<?php echo htmlspecialchars( $planUpgradeValues["nrholderphone"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
												</div>
											...
											<div class="row2 row">
												...
												<div class="col-md-8">
													<input type="date" placeholder="Nascimento" name="dtholderbirth" class="input-text" value="<?php echo htmlspecialchars( $planUpgradeValues["dtholderbirth"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
										...
										<div class="payment-block">
											...
											<div class="row2">
												<input type="text" placeholder="CEP do Titular" name="zipcode" class="input-text" value="<?php echo htmlspecialchars( $planUpgradeValues["zipcode"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
												<!--<input type="submit" Atualizar CEP" id="place_order" class="button alt" formaction="/checkout" formmethod="get">-->
											</div>

											<div class="row2">
												<input type="text" placeholder="Logradouro, rua, avenida" name="desholderaddress" class="input-text" value="<?php echo htmlspecialchars( $planUpgradeValues["desholderaddress"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
											</div>

											<div class="row2">
												<input type="text" placeholder="Número" name="desholdernumber" class="input-text" value="<?php echo htmlspecialchars( $planUpgradeValues["desholdernumber"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
											</div>

											<div class="row2">
												<input type="text" placeholder="Complemento (opcional)" name="desholdercomplement" class="input-text" value="<?php echo htmlspecialchars( $planUpgradeValues["desholdercomplement"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
							                </div>

							                <div class="row2">
												<input type="text" placeholder="Bairro" name="desholderdistrict" class="input-text" value="<?php echo htmlspecialchars( $planUpgradeValues["desholderdistrict"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
											</div>
