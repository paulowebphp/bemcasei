<?php if(!class_exists('Rain\Tpl')){exit;}?><style type="text/css">
    ...
    /********************************BANNER*****************************************/
    #banner {
        background: url("/res/images/template/banner/banner4.jpg") no-repeat center;
        background-size: cover;
        width: 100%;
        position: relative;
    }
    #frame{
        background: url("/res/images/frame/frame4.png") no-repeat center;
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="section-see-more">
                    ...
                    <a href='/template/<?php echo getTemplate(); ?>/festa'>
