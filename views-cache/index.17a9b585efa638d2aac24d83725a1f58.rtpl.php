    ...
    -->
        ...
        <div class="row bottom2">
            ...
            <div class="col-md-4 col-12 bottom2">
                ...
                <div class="img-promotion2 bottom2">
                    <img src="/res/images/promotions/banner9.jpg" alt="Imagem de um Casal">
                </div>
            ...
            <div class="col-md-8 col-12 bottom1">
                ...
                <div class="bottom1">
                    <h3>A melhor forma de iniciar sua vida a dois é sem dívidas e com sua vida financeira bem organizada!</h3>
                </div>
                    ...
                    <div class="card1">
                        ...
                        <div class="body-header">
                            ...
                            <div class="card-image">
                                ...
                                <img alt="Bem Casei Site de Casamento" src="/res/images/promotions/photo/<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-12 bottom1">
                ...
                <div class="bottom1">
                    <h3>Sua Compra do Casamento Pocket está 100% Coberto Por Uma Garantia De 10 Dias!</h3>
                </div>

                <div class="bottom1">
                    <h3>Se neste período você não estiver satisfeito com o seu investimento, tudo o que você tem que fazer é entrar no Chat na Área de <strong>Central de Ajuda</strong> e pedir a evolução da sua compra!</h3>
                </div>
