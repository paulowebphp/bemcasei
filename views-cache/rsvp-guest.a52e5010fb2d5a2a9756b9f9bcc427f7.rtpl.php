...
<body>
  ...
  <section id="email-canvas">
      ...
      <div class="email-row detail">
        ...
        <span class="email-label1">Data: &nbsp;&nbsp;</span><span class="email-label2"><?php echo formatDate($rsvp["dtregister"]); ?></span>
      ...
      <div class="email-row detail">
        ...
        <span class="email-label1">E-mail: &nbsp;&nbsp;</span><span class="email-label2"><?php echo htmlspecialchars( $rsvp["desemail"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
      ...
      <?php if( $rsvp["inchildrenconfigconfirmed"] == 1 ){ ?>
        ...
        <div class="email-row2 detail">
          ...
          <span class="email-label1">Nomes dos Adultos: &nbsp;&nbsp;</span><span class="email-label2"><?php echo htmlspecialchars( $rsvp["desadultsaccompanies"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>

        </div><!--col-->
        <?php }else{ ?>
        <div class="email-row detail">
      
          <span class="email-label1">Adultos: &nbsp;&nbsp;</span><span class="email-label2">0</span>
        ...
        <div class="email-row2 detail">
          ...
          <span class="email-label1">Nomes das Crianças: &nbsp;&nbsp;</span><span class="email-label2"><?php echo htmlspecialchars( $rsvp["deschildrenaccompanies"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>

        </div><!--col-->
        <?php }else{ ?>
        <div class="email-row detail">
        
          <span class="email-label1">Crianças menores que <?php echo htmlspecialchars( $rsvp["inchildrenconfigconfirmed"], ENT_COMPAT, 'UTF-8', FALSE ); ?> anos de idade: &nbsp;&nbsp;</span><span class="email-label2">0</span>
      ...
      <?php }else{ ?>
        ...
        <div class="email-row2 detail">
          ...
          <span class="email-label1">Nomes dos Acompanhantes: &nbsp;&nbsp;</span><span class="email-label2"><?php echo htmlspecialchars( $rsvp["desadultsaccompanies"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
  
        </div><!--col-->
        <?php }else{ ?>
        <div class="email-row detail">
       
          <span class="email-label1">Acompanhantes: &nbsp;&nbsp;</span><span class="email-label2">0</span>
