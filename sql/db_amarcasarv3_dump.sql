...
CREATE TABLE `tb_leads` (
  ...
  `desoriginalpassword` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `nrddd` int(2) DEFAULT NULL,
  `nrphone` bigint(20) DEFAULT NULL,
...
INSERT INTO `tb_outerlists` VALUES (1,48,1,1,'Minha Lista','Minha lista','magazineluiza.com/meusite','Lá onde o vento faz a curva',3131313131,'2019-11-24 19:21:21'),(2,49,1,1,'José Labrêro','LOREm ipsum LOREm ipsum LOREm ipsum LOREm ipsum LOREm ipsum LOREm ipsum LOREm ipsum LOREm ipsum','fat32.com.br','Rua Tal número Tal Bairro Tal Cidade Tal Estado Tal',3131313131,'2019-12-10 18:04:12'),(3,49,1,2,'Lista Á','LOREm ipsum LOREm ipsum LOREm ipsum LOREm ipsum LOREm ipsum LOREm ipsum LOREm ipsum LOREm ipsum LOREm ipsum','fat32.com.br','Rua Tal número Tal Bairro Tal Cidade Tal Estado Tal',3232323232,'2019-12-10 18:04:29'),(4,66,1,0,'Lista Á','validatePlanDomain validatePlanDomain validatePlanDomain validatePlanDomain validatePlanDomain validatePlanDomain','fat32.com.br','Rua Tal número Tal Bairro Tal Cidade Tal Estado Tal',3232323232,'2019-12-15 19:36:04');
...
INSERT INTO `tb_stakeholders` VALUES (1,49,1,4,'Mateus Ternos','Lorem ipsum et ipsum lorem lorelai Lorem ipsum et ipsum lorem lorelai Lorem ipsum et ipsum lorem lorelai Lorem ipsum et ipsum lorem lorelai Lorem ipsum et ipsum lorem lorelai','Roupas','Rua Tal número Tal Bairro Tal Cidade Tal Estado Tal','mateus_@gmail.com','fat32.com.br',3131313131,'2019-12-10 14:37:02'),(3,49,1,3,'Ana Clara','Lorem ipsum et ipsum lorem lorelai Lorem ipsum et ipsum lorem lorelai Lorem ipsum et ipsum lorem lorelai Lorem ipsum et ipsum lorem lorelai','Cerimonialista','Rua Tal número Tal Bairro Tal Cidade Tal Estado Tal','ana@fgsfsf.com','fat32.com.br',3131313131,'2019-12-10 14:38:17'),(7,49,1,0,'Fornecedor Açaí','lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum','Cabeleireiro2','Rua Tal número Tal Bairro Tal Cidade Tal Estado Tal','jpccambraia@gmail.com','fat32.com.br',3232323232,'2019-12-10 16:52:29'),(8,66,1,1,'Açaí','validatePlanDomain validatePlanDomain validatePlanDomain validatePlanDomain validatePlanDomain validatePlanDomain validatePlanDomain validatePlanDomain validatePlanDomain2','Cabeleireiro2','Rua Tal, número Tal, Bairro Tal, Cidade Tal, Estado Tal','jpccambraia@gmail.com','fat32.com.br',3232323232,'2019-12-15 19:34:34');
