...
var card = new Card({
    ...
    formSelectors: {
        numberInput: 'input[name="descardcode_number"]', // optional — default input[name="descardcode_number"]
        expiryInput: 'input#expiry', // optional — default input[name="expiry"]
        cvcInput: 'default input[name="descardcode_cvc"]', // optional — default input[name="descardcode_cvc"]
        nameInput: 'input[name="desholdername"]' // optional - defaults input[name="desholdername"]
    },
...
$(document).on('click', '#options-payments2', function(){
	...
	let html = `<div class="row centralizer">
...
$(document).on('click', '#options-payments3', function(){
	...
	let html = `<div class="payment-warn payment-block">
